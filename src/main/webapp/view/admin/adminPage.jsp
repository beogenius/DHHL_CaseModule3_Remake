...
<div class="container-fluid">
    ...
    <br>
    <div class="row">
        <div class="col-lg-6" style=" padding-right: 20px !important;">
            <div class="" style="background-color:yellow; padding: 10px;">
                <h3>BUYER LIST</h3>
                <br>
        ...
        <div class="col-lg-6" style="padding-left: 20px">
                <div class="" style="background-color:pink; padding: 10px;">
            <h3>SHOP LIST</h3>
            <br>
            <table class="table table-striped">
                <tr>
